...
function Content() {
    return (
        <>
        <div container style={{padding:'0px 10px'}}>
            <div style={{display:'flex', justifyContent:'space-evenly', textAlign:'center', alignItems:'center', padding:'10px 0px'}} >
                <div>
                    <div style={{color:'rgb(61, 198, 193)', fontWeight:'500', fontSize:'2.5vw'}} >0.48 %</div>
                    <div style={{color:'gray', fontWeight:'300', fontSize:'1.5vw'}} >5 mins</div>
                </div>
                <div>
                    <div style={{color:'rgb(61, 198, 193)', fontWeight:'500', fontSize:'2.5vw'}} >0.64 %</div>
                ...
                <div>
                    ...
                    <div style={{fontWeight:'400', fontSize:'5vw'}} >₹ 25,11,600</div>
                    <div style={{fontWeight:'300', fontSize:'1vw', letterSpacing:'0.75px', color:'gray'}} >Average BTC/INR net price including commission</div>
                </div>
                <div>
                    <div style={{color:'rgb(61, 198, 193)', fontWeight:'500', fontSize:'2.5vw'}} >10.48 %</div>
                    <div style={{color:'gray', fontWeight:'300', fontSize:'1.5vw'}} >1 day</div>
                </div>
                <div>
                    <div style={{color:'rgb(61, 198, 193)', fontWeight:'500', fontSize:'2.5vw'}} >12.06 %</div>
        ...
        <div container style={{padding:'16px'}} >
        <table className="table" style={{color:'gray'}} >
            ...
            <tbody style={{color:'#0c0f48'}} >
                ...
                <td className='p-3' style={{color:'#0c0f48', fontWeight:'600'}} >WazirX</td>
